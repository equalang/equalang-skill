...
Guárdala en `~/.config/equalang/.env`, una vez por equipo: este skill y el servidor MCP de Equalang la leen ahí, y se conserva aunque reinstales o actualices cualquiera de los dos.
