...
**แปลทั้งไฟล์ เลย์เอาต์อยู่ครบ** [Agent Skill](https://agentskills.io) สำหรับ [Equalang](https://equalang.com) - เครื่องมือแปลภาษาด้วย AI ที่ทำงานกับไฟล์ทั้งไฟล์: ส่ง PDF ไปก็ได้ PDF กลับมา ส่งสไลด์ไปก็ได้สไลด์กลับมา ตาราง รูปภาพ และสูตรอยู่ที่เดิมครบ นอกจากนี้ยังแปลคำบรรยายและรูปภาพ เปลี่ยนเสียงและวิดีโอเป็นคำบรรยายที่แปลแล้วหรือบทถอดเสียง และแปลข้อความสั้น ๆ จำนวนมากในคราวเดียว ใช้ได้ใน Claude Code, Codex, Cursor, CodeBuddy และเอเจนต์อื่นทุกตัวที่โหลด Agent Skills ได้
...
> ติดตั้งสกิล Equalang โดยทำตามคำแนะนำที่ https://equalang.com/install/skill-install.md
...
```bash
# จะมีค่าใช้จ่ายเท่าไร? ฟรี และยังไม่เริ่มแปลจริง
...
ทุกคำสั่งพิมพ์ JSON ออกมา บอกว่าไฟล์ถูกเขียนไว้ที่ไหนและใช้ไปเท่าไร หรือมีอะไรผิดพลาด ใส่ `--help` กับคำสั่งใดก็ได้เพื่อดูแฟล็กของคำสั่งนั้น [SKILL.md](../SKILL.md) คือสิ่งที่เอเจนต์อ่านเอง

รหัสภาษามีหน้าตาแบบ `en`, `zh-CN`, `ja` รัน `languages` เพื่อดูทั้งหมด หรือ `languages chinese` เพื่อค้นหา งานใช้เวลาหลายนาที - คำสั่งจะรอให้ และถ้าคุณขัดจังหวะ `status <job_id>` ก็กลับมาติดตามต่อได้
