...
भाषा कोड `en`, `zh-CN`, `ja` जैसे होते हैं; `languages` उन्हें लाइव API से पढ़ता है, इसलिए Equalang जो भाषा जोड़ता है वह बिना अपडेट के उपलब्ध हो जाती है। जॉब में कुछ मिनट लगते हैं - कमांड इंतज़ार करता है, और बीच में रोकने पर `status <job_id>` उसे दोबारा पकड़ लेता है।
