...
इसे हर मशीन पर एक बार `~/.config/equalang/.env` में सहेजें: यह स्किल और Equalang MCP सर्वर दोनों इसे वहीं से पढ़ते हैं, और किसी को भी दोबारा इंस्टॉल या अपडेट करने पर यह फ़ाइल बनी रहती है।
